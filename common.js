...
function openWindow(zindex,width,height,alpha){
	...
	msgDiv.innerHTML="<div class='msgtitle'><div id='msgtitle'></div><img onclick='closeWin()' src='https://cdn.jsdelivr.net/gh/xingchangppt/MainnetRelease/btn_close.gif' /></div><div id='msgbody' style='height:"+height+"px'></div>";
